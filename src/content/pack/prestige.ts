...
export const mechanics: MechanicDef[] = [
  ...
  { id: 'stewards', name: 'Stewards', glyph: '🧑‍🌾', atTurn: 6, seasonName: 'Winter II', implemented: true, medal: 'hat_snail',
    palette: { leaf: '#b9d3e6', bark: '#3d4250', accent: '#a8e0ff', particle: '#ffffff', particleGlyph: '❄️' },
    desc: 'A Steward on every bough buys the cheapest lodge or crew level every 30 s (never more than a tenth of your stock). The Head Steward node also tunes feed dials.',
    introGoals: [{ id: 'steward_buys', name: 'Let the Stewards buy 10 levels', cond: { kind: 'stewardBuys', min: 10 }, reward: { fireflies: 20 }, tab: 'grow', target: 'stewards' }] },
  { id: 'charts', name: 'Star Charts', glyph: '🔭', atTurn: 7, seasonName: 'Spring II', implemented: true, medal: 'frame_astrolabe',
    palette: { leaf: '#9be08a', bark: '#5c3f27', accent: '#ffc9e3', particle: '#ffd6ea', particleGlyph: '🌸' },
    desc: 'Pick one constellation each Season on the Rings tab: The Gatherer (raws x2), The Loom (crafting x2), The Lantern (Nightwatch +50%) or The Hammer (strikes x1.5). The Astrolabe node lets you pick two.',
    introGoals: [{ id: 'chart_pick', name: 'Choose a constellation', cond: { kind: 'charts', min: 1 }, reward: { fireflies: 20 }, tab: 'rings', target: 'charts' }] },
  { id: 'expeditions', name: 'Expeditions', glyph: '🧭', atTurn: 8, seasonName: 'Summer II', implemented: true, medal: 'title_explorer', annex: 'trailhead',
    palette: { leaf: '#2e7d46', bark: '#3a2617', accent: '#fff07a', particle: '#fff8b0', particleGlyph: '⚡' },
    desc: 'Build the Trailhead and send Folk off-tree for 2, 4 or 8 hours; they come back with a Bark, Amber or Star chest, even while you are away.',
    introGoals: [{ id: 'exped_build', name: 'Build the Trailhead', cond: { kind: 'annex', id: 'trailhead' }, reward: { fireflies: 20 }, tab: 'grow', target: 'annex:trailhead' }, { id: 'exped_send', name: 'Send an expedition', cond: { kind: 'expeditions', min: 1 }, reward: { fireflies: 30 }, tab: 'grow', target: 'expedition' }] },
  { id: 'greatring', name: 'Great Ring', glyph: '🌀', atTurn: 10, seasonName: 'The Great Ring', implemented: true, medal: 'frame_greatring',
    ...
    desc: 'Every ten Seasons: everything x2, one extra limb on every bough, the Great Ring frame and, at Season 20, the Elder Crown.' },
]
