...
export const runes: BoostDef[] = [
  ...
  { id: 'rune_thrum', name: 'Rune of Thrum', glyph: '🥁', good: 'glass', baseCost: 10, costGrowth: G, maxTier: 8,
    effect: { target: 'tap', op: 'mult', value: 1.25 }, unlock: { kind: 'crew', id: 'glasshouse' }, desc: 'Strike value x1.25 per tier. Priced in Glass.' },
