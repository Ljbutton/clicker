...
export function SceneHost() {
  ...
  return (
    <div class="scene">
      ...
      <button class="tap-target" data-testid="tap-target" aria-label="Strike the trunk" onPointerDown={(e) => { e.preventDefault(); game.strike(e.clientX, e.clientY); haptic('light') }} />
    </div>
  )
}
